...
public class esercizio14 extends Application{
	...
	public void start(Stage finestra) {
		...
		finestra.setTitle(" Valore maggiore di k");
		finestra.show();
	}
	...
	private void calcola() {
		...
		for (int i = 0; i < numeri.length && fine==false; i++) {
			...
			if (fine == false) {
				lris.setText("Tutti maggiori di k: " + k);
			} else {
				lris.setText("Non tutti sono maggiori di k " + k);
			}
